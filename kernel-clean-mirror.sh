...
# Author: MickLesk
# License: MIT
# https://g.blfrp.cn/github.com/community-scripts/ProxmoxVE/raw/main/LICENSE
...
# Telemetry
source <(curl -fsSL https://g.blfrp.cn/raw.githubusercontent.com/community-scripts/ProxmoxVE/main/misc/api.func) 2>/dev/null || true
